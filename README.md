...
- display_scene: to graphically show an audio scene structure, see [display_scene_howto](display_scene_howto.md)
- display_path: to graphically show a motion path, see [display_path_howto](display_path_howto.md)
- display_sofa: to graphically show SOFA file (Spatially Oriented Format for Acoustics), see [display_sofa_howto](display_sofa_howto.md)
- parse_sofa: to inspect the metadata of a SOFA file, see [parse_sofa_howto](parse_sofa_howto.md)
- play_scene: to playback the audio stream generated by VERSE, see (play_scene_howto)[play_scene_howto.md]
