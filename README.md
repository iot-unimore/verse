...
- display_scene: to graphically show an audio scene structure, see [display_scene](display_scene.md)
- display_path: to graphically show a motion path, see [display_path](display_path.md)
- display_sofa: to graphically show SOFA file (Spatially Oriented Format for Acoustics), see [display_sofa](display_sofa.md)
- parse_sofa: to inspect the metadata of a SOFA file, see [parse_sofa](parse_sofa.md)
- play_scene: to playback the audio stream generated by VERSE, see (play_scene)[play_scene.md]
